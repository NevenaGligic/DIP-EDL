...
def train_postnet(model, train_loader, val_loader, max_epochs=200, frequency=2, patience=5, model_path='saved_model', full_config_dict={}):
    model.to(device)
    model.train()
...
def train_sequential(model, train_loader, val_loader, max_epochs=200, frequency=2, patience=5, model_path='saved_model', full_config_dict={}):
    ...
    train_losses_1, val_losses_1, train_accuracies_1, val_accuracies_1 = train_postnet(model,
                                                                               train_loader,
                                                                               val_loader,
